...
def facebook_graph(url):
    ...
    try:
        ...
        print('Error getting score for `facebook_graph` ({0}): {1}'.format(url, e))
        return 0
...
def facebook(url):
    ...
    try:
        ...
        print('Error getting score for `facebook` ({0}): {1}'.format(url, e))
        return 0
...
def twitter(url):
    ...
    while retries < 5:
        try:
            ...
            print('Error getting score for `twitter` ({0}): {1}'.format(url, e))
            return 0
...
def linkedin(url):
    ...
    try:
        ...
        print('Error getting score for `linkedin` ({0}): {1}'.format(url, e))
        return 0
...
def stumbleupon(url):
    ...
    try:
        ...
        print('Error getting score for `stumbleupon` ({0}): {1}'.format(url, e))
        return 0
